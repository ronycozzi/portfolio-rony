...
(() => {
  ...
  const i18n = {
    es: {
      ...
      'meta.home.description': 'Sitios web rápidos, landings, APIs ligeras e integraciones para marcas, estudios y startups que necesitan una experiencia digital clara y lista para producción.',
    ...
    en: {
      ...
      'hero.title2': 'communicates.',
      'hero.title3': 'Code that holds.',
      ...
      'hero.trust1': 'Response < 24h',
      'hero.trust2': 'Technical SEO included',
      'hero.trust3': 'Clean deploy',
      ...
      'problem.title1': 'A website cannot just',
      'problem.title2': 'look good.',
      'problem.copy': 'It also has to load fast, guide the user, adapt to content, work on mobile, be indexable and remain maintainable.',
      'problem.c1.title': 'Design without a goal',
      'problem.c1.desc': 'It looks correct, but it does not guide the user toward a clear action.',
      'problem.c2.title': 'Slow websites',
      'problem.c2.desc': 'Heavy images, unnecessary scripts and weak structure hurt conversion and SEO.',
      'problem.c3.title': 'Hard-to-maintain code',
      'problem.c3.desc': 'Every change becomes expensive when there are no components, structure or technical criteria.',
      'problem.c4.title': 'Weak forms',
      'problem.c4.desc': 'The user reaches out, but the business does not receive or process that information well.',
      ...
      'problem.close': 'My work is to connect design, code and strategy so the website works as a real tool, not just an online presence.',
      ...
      'services.copy': 'Four ways to work depending on scope: a fast landing page, a complete site, full stack integrations or improvement for what you already have online.',
      'services.s1.title': 'Conversion landing page',
      'services.s1.tag': 'Single page',
      'services.s1.desc': 'For launches, campaigns, specific services or lead capture. One fast, measurable page focused on a single action.',
      'services.s1.i1': 'Design and development',
      'services.s1.i2': 'Base copy focused on conversion',
      'services.s1.i3': 'Connected form or WhatsApp',
      'services.s1.i4': 'Basic technical SEO + mobile performance',
      'services.s1.ideal': 'Ideal if you need to publish a focused page quickly.',
      'services.s1.cta': 'Ask about a landing',
      'services.s2.title': 'Complete website',
      'services.s2.tag': 'Complete project',
      'services.s2.desc': 'For brands, studios, professionals and businesses that need a full presence: architecture, design, development and deploy with SEO and accessibility from the base.',
      ...
      'services.s3.desc': 'For projects that need the website to do more than look good: forms, APIs, data, simple panels or automations.',
      ...
      'services.s3.ideal': 'Ideal if your site needs to process information, save data or connect with other tools.',
      'services.s3.cta': 'Ask about an integration',
      'services.s4.title': 'Optimization and maintenance',
      'services.s4.tag': 'Continuous improvement',
      'services.s4.desc': 'For published websites that need to improve speed, SEO, accessibility or fix issues without rebuilding everything.',
      ...
      'services.s4.ideal': 'Ideal if your website already exists but is not performing as it should.',
      'services.s4.cta': 'Improve my website',
      'services.note.title': 'When I am not the best fit.',
      'services.note.p1': 'I prefer to say it upfront: I am not the best fit if you need a native app, a complex enterprise backend, a dedicated 40-hour-per-week team or a platform with many advanced business rules.',
      'services.note.p2': 'If the project is beyond my scope, I can help you size it or recommend another path.',
      'services.more': 'View services in detail',
      'contactCard.eyebrow': '[ Direct contact ]',
      'contactCard.title': 'Do you have a website to launch,<br/>improve or rebuild?',
      'contactCard.copy': 'Tell me what you need to achieve and I will reply with the clearest path forward.',
      ...
      'proc.title2': 'to a published site.',
      'proc.copy': 'A clear process to define scope, validate structure, design, develop, review and deliver without surprises.',
      'proc.more': 'View the full process',
      'home.fit.eyebrow': '[ Who it is for ]',
      ...
      'quality.q2': 'Baseline WCAG accessibility: semantics, visible focus and contrast',
      'quality.q3': 'Mobile-first and real responsive behavior across breakpoints',
      'quality.q4': 'Performance: optimized images, lazy loading and stable CLS',
      'quality.q5': 'Connected form or WhatsApp path for inquiries',
      ...
      'faqmini.more': 'View all questions',
      'work.years': 'Years',
      'work.role': 'Role',
      ...
      'work.cucu.problem': 'A creative studio needs a distinctive web presence and simple navigation to present identity, services and contact.',
      'work.cucu.solution': 'Editorial site with scroll animation, microinteractions and a clear structure that turns visits into inquiries.',
      ...
      'work.luco.problem': 'A food brand needs a mobile-first digital menu that is accessible from any phone.',
      'work.luco.solution': 'PWA with offline menu, Schema.org, mobile priority and optimized loading.',
      'work.luco.role': 'Full design and development.',
      'work.luco.result': 'Fast, installable menu that remains usable offline.',
      ...
      'work.sellink.problem': 'An agency needs to present services, brand and contact with a dark visual language and modular structure.',
      ...
      'work.sellink.result': 'Professional, scalable presentation for creative services.',
      ...
      'work.cognition.problem': 'Communicate a complex AI offer in a way that is clear and actionable.',
      'work.cognition.solution': '11-page platform with ROI calculator, intent-based chat and PWA behavior.',
      'work.cognition.role': 'Full design and development.',
      'work.cognition.result': 'Complete site that explains AI, captures intent and guides users.',
      ...
      'about.lead': "I work at the intersection of design, code and strategy. My goal is not only to publish a website: it is to build a digital presence that loads fast, communicates clearly and remains easy to maintain over time.",
      'about.fit.eyebrow': '[ Fit ]',
      'about.fit.title': 'When I can help — and when I cannot.',
      'about.fit.yes': 'I am a good fit if you need',
      'about.fit.y1': 'A site, landing page or web integration with identity, speed and maintainability.',
      'about.fit.y2': 'Technical SEO, accessibility and performance from the first commit.',
      'about.fit.y3': 'Direct communication, clear scope and no-surprises delivery.',
      'about.fit.y4': 'A full stack profile for a remote product team.',
      'about.fit.no': 'I am not the best fit if you need',
      'about.fit.n1': 'A native iOS/Android app.',
      'about.fit.n2': 'A complex enterprise backend with heavy business rules.',
      'about.fit.n3': 'A dedicated 40-hour-per-week team from day one.',
      'about.fit.note': 'If the project is beyond my scope, I can help you size it or recommend another path.',
      'about.bio.heading': 'Bio',
      ...
      'meta.home.description': 'Fast websites, landing pages, lightweight APIs and integrations for brands, studios and startups that need a clear, production-ready digital experience.',
      ...
      'process.title2': 'to a published site.',
      'process.lead': 'A clear process to define scope, validate structure, design, develop, review and deliver without surprises.',
      ...
      'process.step1.avoid': 'Starting without direction or a fixed budget',
      ...
      'process.step2.avoid': 'Redesigning the structure halfway through the project',
      'process.step2.del1': 'Sitemap',
      ...
      'process.step3.avoid': 'Coding against a design nobody validated',
      ...
      'process.step4.del': 'Working Vercel preview + GitHub repo',
      'process.step4.avoid': 'Moving blindly without seeing real progress',
      ...
      'process.step5.del': 'QA report with real Lighthouse scores',
      'process.step5.avoid': 'Publishing with errors your customer discovers',
      ...
      'process.step6.del': 'Production site, access, documentation and 30 days of support',
      'process.step6.avoid': 'Being tied to your developer for every change',
      ...
      'faq.cat1': 'Project',
      'faq.cat2': 'Services',
      'faq.cat3': 'Work and payments',
      'faq.q1': 'How long does a web project take?',
      'faq.a1': '<p><strong>A complete website: 2–4 weeks. A landing page: 5–7 business days.</strong></p><p>The timeline depends on three factors:</p><ul><li>Number of pages and sections.</li><li>Integrations: payments, forms, APIs.</li><li>How quickly material arrives: copy, photos and logo.</li></ul><p>In the briefing I give you a fixed timeline before we start.</p>',
      'faq.q2': 'What is included in a project?',
      'faq.a2': '<p><strong>Design, development, deployment, one revision round and 30 days of post-launch support.</strong></p><p>In concrete terms:</p><ul><li>Visual design and information architecture.</li><li>Full development, optimized for performance and technical SEO.</li><li>Production launch with your domain and HTTPS.</li><li>One structural revision round before final delivery.</li><li>30 days of support for adjustments and fixes.</li></ul>',
      'faq.q3': 'Do you handle maintenance after delivery?',
      'faq.a3': '<p><strong>Yes. Monthly maintenance plans or one-off hourly fixes.</strong></p><p>The monthly plan includes:</p><ul><li>Content updates and minor changes.</li><li>Backups and uptime monitoring.</li><li>Bug fixes.</li></ul><p>If you do not want a fixed plan, I can handle one-off hourly fixes.</p>',
      'faq.q4': 'Do you work with brands outside Argentina?',
      'faq.a4': '<p><strong>Yes. I work 100% remotely with clients from any country.</strong></p><ul><li>Timezone GMT-3 (Córdoba, Argentina).</li><li>Availability for LATAM working hours and late UTC afternoons/evenings for Europe or North America.</li><li>International projects: quoted and charged in USD.</li></ul>',
      'faq.q5': 'Do you build ecommerce?',
      'faq.a5': '<p><strong>Yes: catalogs with integrated checkout (Mercado Pago, Stripe, PayPal).</strong></p><p>Where I fit well and where I do not:</p><ul><li>Catalog + checkout + payment gateway: I can build it custom.</li><li>Hundreds of products, inventory management and complex discount logic: I recommend evaluating a dedicated platform like Shopify or WooCommerce.</li></ul><p>I am honest about that: if your case needs a platform, I will say so before quoting.</p>',
      'faq.q6': 'Do you handle backend and integrations?',
      'faq.a6': '<p><strong>Yes. Lightweight backend and integrations are part of the service.</strong></p><p>I work with:</p><ul><li>Node.js, JavaScript/TypeScript, REST APIs and serverless functions.</li><li>Connected forms, simple authentication and internal panels.</li><li>Supabase, Firebase, Airtable, transactional email, analytics and webhooks.</li></ul><p>If the project needs a large platform —complex roles, recurring payments, inventory— we scope it properly before promising anything.</p>',
      'faq.q7': 'What if I do not like the result?',
      'faq.a7': '<p><strong>There is one major revision before final delivery where you can request structural changes.</strong></p><p>Also:</p><ul><li>Minor changes (copy, colors, images) can happen at any point during development.</li><li>You see real progress in an online preview, not screenshots.</li><li>If the project is not going in the right direction, we discuss it before it becomes a problem.</li></ul>',
      'faq.q8': 'What payment methods do you accept?',
      'faq.a8': '<p><strong>Bank transfer, PayPal and, if you prefer, stablecoins.</strong></p><p>For clients in Argentina: transfer in ARS or USD. For international clients: PayPal or USD transfer. I also accept USDT/USDC as an alternative for international payments; if that is more practical, let me know at the start of the project.</p>',
      'faq.q9': 'How is your work different from an agency?',
      'faq.a9': '<p><strong>You talk directly with the person building your site, without intermediaries.</strong></p><p>At an agency your project usually passes through 4–6 people. With me:</p><ul><li>Faster communication, with less handoff loss.</li><li>More control over technical decisions.</li><li>One person responsible from start to finish.</li></ul><p>The tradeoff: I do not scale to ten projects in parallel — that is why I work with few clients at a time.</p>',
      'faq.q10': 'When am I not the right fit for your project?',
      'faq.a10': '<p><strong>When the project needs a team, not a single developer.</strong></p><p>I am probably not the best fit if you need:</p><ul><li>A portal with complex authentication and many user roles.</li><li>A native mobile app (iOS/Android).</li><li>An enterprise backend with heavy business logic or high concurrency.</li><li>A dedicated 40h/week team.</li></ul><p>For those cases I will say it at the beginning and, if I can, recommend someone else.</p>',
      'faq.q11': 'Do I need to understand technology to work with you?',
      'faq.a11': '<p><strong>No. My job is to translate your business goal into technical decisions.</strong></p><p>You tell me what you need to achieve; I decide how to implement it and explain it in plain language. You do not need to know what a Service Worker is to have a fast, well-built site.</p>',
      'faq.q12': 'What do I need to get started?',
      'faq.a12': '<p><strong>A clear idea of what you want to achieve and your brand material. I handle the rest.</strong></p><p>The minimum to start:</p><ul><li>The goal of the site: sell, capture inquiries, show your work.</li><li>Logo and copy if you have them — if not, we solve it in the briefing.</li><li>Reference sites you like (optional, but helpful).</li></ul><p>With that, we do the first call and you leave with scope and budget defined.</p>',
      'faq.q13': 'How do you charge?',
      'faq.a13': '<p><strong>50% upfront to start and 50% when the site is delivered working.</strong></p><ul><li>Fixed quote before starting: you know the total from day one.</li><li>No surprise costs: if the scope changes, it is quoted separately and approved by you.</li><li>For international projects, I quote and charge in USD.</li></ul>',
