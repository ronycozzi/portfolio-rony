...
(() => {
  ...
  const i18n = {
    es: {
      ...
      'work.status': 'Estado',
      'work.status_val': "Publicado",
      'work.visit': 'Ver sitio',
      'work.eyebrow': "[ Trabajos ]",
      'work.lead': "Webs terminadas y publicadas para rubros distintos: inmobiliaria, estética, jurídico, software e indumentaria. CodeSign Córdoba es el proyecto principal para mostrar.",
      'projects.eyebrow': "[ Proyectos publicados ]",
      'projects.title1': "Trabajos reales",
      'projects.title2': "en producción.",
      'projects.copy': "Una selección de webs terminadas y publicadas: negocios locales, servicios profesionales, software e indumentaria. CodeSign es el proyecto principal por alcance y nivel de producto.",
      'projects.featured.badge': "Destacado",
      'projects.grid_aria': "Más proyectos publicados",
      'projects.visit': "Ver sitio",
      'projects.more': "Ver todos los proyectos",
      'projects.codesign.sector': "Portal inmobiliario",
      'projects.codesign.desc': "Portal inmobiliario para venta y alquiler de propiedades en Córdoba Capital, con búsqueda clara, catálogo escaneable y foco en conversión.",
      'projects.swan.sector': "Estética & belleza",
      'projects.swan.desc': "Sitio de servicios estéticos, pilates y belleza con presentación clara de tratamientos y turnos online.",
      'projects.sung.sector': "Estudio jurídico",
      'projects.sung.desc': "Web institucional para práctica jurídica empresarial, con tono sobrio, jerarquía de áreas y contacto profesional.",
      'projects.nova.sector': "Software & soporte",
      'projects.nova.desc': "Sitio para servicios de software, automatizaciones, infraestructura y soporte técnico para operación diaria.",
      'projects.moncre.sector': "Moda masculina",
      'projects.moncre.desc': "Web editorial para marca de indumentaria masculina atemporal, con foco en identidad, piezas y próximas ediciones.",
      ...
      'meta.work.description': "Proyectos web publicados de Rony Cozzi: CodeSign Córdoba, Swan Estética, SUNG, NOVA Software y Moncré Studios.",
      ...
      'soon.title1': "Proyectos publicados",
      'soon.title2': "en vivo.",
      'soon.copy': "La nueva selección ya está publicada con trabajos reales para inmobiliaria, estética, servicios legales, software e indumentaria.",
      'soon.detail': "Cada proyecto muestra una decisión distinta de producto: catálogo, conversión, claridad de servicios, identidad visual y experiencia responsive.",
      'soon.cta1': "Ver servicios",
      'soon.cta2': "Empezar el tuyo",
      'signals.l5': "Publicados",
      ...
      'console.status_val': "proyectos publicados: activos",
    },
    en: {
      'nav.home': 'Home',
      'nav.work': 'Work',
      ...
      'work.status': 'Status',
      'work.status_val': "Published",
      'work.visit': 'Visit site',
      'work.eyebrow': "[ Work ]",
      'work.lead': "Finished and published websites across different sectors: real estate, beauty, legal services, software and apparel. CodeSign Córdoba is the main project to showcase.",
      'projects.eyebrow': "[ Published projects ]",
      'projects.title1': "Real work",
      'projects.title2': "in production.",
      'projects.copy': "A selection of finished and published websites: local businesses, professional services, software and apparel. CodeSign is the main project because of its scope and product depth.",
      'projects.featured.badge': "Featured",
      'projects.grid_aria': "More published projects",
      'projects.visit': "Visit site",
      'projects.more': "See all projects",
      'projects.codesign.sector': "Real estate portal",
      'projects.codesign.desc': "Real estate portal for property sales and rentals in Córdoba Capital, with clear search, scannable listings and conversion focus.",
      'projects.swan.sector': "Beauty & aesthetics",
      'projects.swan.desc': "Website for aesthetic treatments, pilates and beauty services, with clear treatment presentation and online booking.",
      'projects.sung.sector': "Legal studio",
      'projects.sung.desc': "Institutional website for business legal practice, with sober tone, clear practice areas and professional contact flow.",
      'projects.nova.sector': "Software & support",
      'projects.nova.desc': "Website for software, automation, infrastructure and technical support services for daily operations.",
      'projects.moncre.sector': "Menswear",
      'projects.moncre.desc': "Editorial website for a timeless menswear brand, focused on identity, pieces and upcoming editions.",
      ...
      'meta.work.description': "Published web projects by Rony Cozzi: CodeSign Córdoba, Swan Estética, SUNG, NOVA Software and Moncré Studios.",
      ...
      'soon.eyebrow': "[ Work ]",
      'soon.title1': "Published projects",
      'soon.title2': "live.",
      'soon.copy': "The new selection is now published with real work for real estate, aesthetics, legal services, software and apparel.",
      'soon.detail': "Each project shows a different product decision: catalog, conversion, service clarity, visual identity and responsive experience.",
      'soon.cta1': "See services",
      'soon.cta2': "Start yours",
      'signals.l5': "Published",
      ...
      'console.status_val': "published projects: live",
    },
  };
