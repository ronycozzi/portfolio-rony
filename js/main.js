...
(() => {
  ...
  const i18n = {
    es: {
      ...
      'work.status': 'Estado',
      'work.status_val': '4 proyectos · en producción',
      'work.hint': 'Deslizá',
      'work.visit': 'Ver caso de estudio',
      'work.eyebrow': '[ Índice · 02 trabajos ]',
      ...
      'about.bio.p3': 'Disponible para colaboraciones remotas, proyectos puntuales y posiciones internas.',
      ...
      'case.cucu.cover_alt': 'Portada de Cucú Studio — layout editorial con fondo oscuro y acento cobre',
      ...
      'case.luco.tech5.desc': 'Titles y descriptions únicos por sección. Sitemap con priority diferenciada. Core Web Vitals en verde medidos en Lighthouse (lab data).',
      ...
      'case.cognition.tech1.desc': 'Calculadora interactiva en JS puro con inputs deslizantes y resultado animado. Persiste en <code>sessionStorage</code> para que el usuario no pierda sus datos al navegar entre páginas. El resultado se pre-llena en el formulario de demo.',
      ...
      'faq.q10': '¿Cuándo no soy buen encaje para tu proyecto?',
      'faq.a10': 'Soy honesto con esto. Probablemente no sea el mejor encaje si necesitás:<br/><br/>— Un portal con autenticación compleja de usuarios y muchos roles<br/>— Una app móvil nativa (iOS/Android)<br/>— Un backend corporativo con lógica de negocio pesada, permisos avanzados o alta concurrencia<br/>— Un equipo dedicado interno de 40h/semana exclusivas<br/><br/>Para esos casos, te lo digo al principio y si puedo te recomiendo a alguien.',
    ...
    en: {
      ...
      'case.cucu.cover_alt': 'Cucú Studio cover — editorial layout on a dark background with a copper accent',
      ...
      'case.luco.tech5.desc': 'Unique titles and descriptions by section. Sitemap with differentiated priority. Core Web Vitals in the green zone measured with Lighthouse (lab data).',
      ...
      'faq.q10': 'When am I not a good fit for your project?',
      'faq.a10': 'I am honest about this. I am probably not the best fit if you need:<br/><br/>— A portal with complex user authentication and many roles<br/>— A native mobile app (iOS/Android)<br/>— An enterprise backend with heavy business logic, advanced permissions or high concurrency<br/>— A dedicated in-house team working 40h/week exclusively<br/><br/>In those cases I will say it early and, if I can, point you to someone better suited.',
