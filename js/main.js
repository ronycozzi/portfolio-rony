...
(() => {
  ...
  const i18n = {
    es: {
      ...
      'about.lead': "Desarrollo productos web completos con foco en performance, accesibilidad, SEO técnico e integraciones útiles. Cada proyecto del portfolio es una demo construida con estándares de producción, de la idea al deploy.",
    ...
    en: {
      ...
      'about.lead': "Full web product development focused on performance, accessibility, technical SEO and useful integrations. Every project in this portfolio is a demo built to production standards, from idea to deploy.",
      'about.bio.heading': 'Bio',
