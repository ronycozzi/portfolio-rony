...
(() => {
  ...
  const i18n = {
    es: {
      ...
      'services.s1.i2': 'HTML, CSS, JavaScript / React',
      ...
      'services.s3.i2': 'Supabase / Firebase / Airtable',
      ...
      'cap.fe': 'HTML semántico, CSS moderno, JavaScript, React y UI responsive. Interfaces rápidas, accesibles y fáciles de mantener.',
      'cap.backend.title': 'Backend ligero & APIs',
      'cap.backend': 'Node.js, serverless functions, APIs REST y conexión con servicios externos cuando el proyecto necesita lógica real.',
      'cap.data.title': 'Datos e integraciones',
      'cap.data': 'Formularios conectados, Supabase/Firebase, Airtable, email transaccional, analytics, webhooks y flujos de automatización.',
      ...
      'about.bio.p1': 'Full Stack Developer con foco fuerte en frontend, performance e integraciones web. Construyo sitios accesibles, rápidos y mantenibles con HTML, CSS, JavaScript, React y Node.js cuando el proyecto lo necesita.',
    ...
    en: {
      ...
      'cap.fe': 'Semantic HTML, modern CSS, JavaScript, React and responsive UI. Fast, accessible and maintainable interfaces.',
      'cap.backend.title': 'Lightweight backend & APIs',
      'cap.backend': 'Node.js, serverless functions, REST APIs and external service connections when the project needs real logic.',
      'cap.data.title': 'Data and integrations',
      'cap.data': 'Connected forms, Supabase/Firebase, Airtable, transactional email, analytics, webhooks and automation flows.',
      ...
      'about.bio.heading': 'Bio',
      'about.bio.p1': 'Full Stack Developer with a strong focus on frontend, performance and web integrations. I build accessible, fast and maintainable sites with HTML, CSS, JavaScript, React and Node.js when the project needs it.',
