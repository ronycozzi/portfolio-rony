...
(() => {
  ...
  const i18n = {
    es: {
      ...
      'cap.perf': "Optimización de assets, lazy loading, Core Web Vitals. Score Lighthouse 90+ en mis demos (lab data).",
      ...
      'meta.work.description': "Proyectos publicados con foco en identidad, velocidad, estructura y conversión: casos de estudio con problema, solución, stack y resultado.",
      ...
      'about.timeline.i1.desc': "Sitio corporativo para una agencia creativa y plataforma de IA de 11 páginas con calculadora ROI, chat basado en intención y PWA. Construidos como demos con estándares de producción.",
      ...
      'case.gallery.num': "[ Galería ]",
      'case.gallery.title': "El sitio en pantalla",
      'case.gallery.desktop': "Desktop",
      'case.gallery.mobile': "Mobile",
      'case.gallery.cover': "Portada",
      'case.gallery.inner': "Sección interior",
      'case.cucu.gal_d1': "Vista desktop de Cucú Studio: portada",
      'case.cucu.gal_d2': "Vista desktop de Cucú Studio: sección interior",
      'case.cucu.gal_m1': "Vista mobile de Cucú Studio",
      'case.luco.gal_d1': "Vista desktop de Luco Gourmet: portada",
      'case.luco.gal_d2': "Vista desktop de Luco Gourmet: sección interior",
      'case.luco.gal_m1': "Vista mobile de Luco Gourmet",
      'case.sellink.gal_d1': "Vista desktop de Sellink Group: portada",
      'case.sellink.gal_d2': "Vista desktop de Sellink Group: sección interior",
      'case.sellink.gal_m1': "Vista mobile de Sellink Group",
      'case.cognition.gal_d1': "Vista desktop de Cognition: portada",
      'case.cognition.gal_d2': "Vista desktop de Cognition: sección interior",
      'case.cognition.gal_m1': "Vista mobile de Cognition",
      ...
      'legal.terms.s2.p1': "Los cuatro proyectos presentados en este sitio (Cucú Studio, Luco Gourmet, Sellink Group, Cognition) son demos autoiniciados, construidos por Rony Cozzi con marcas ficticias creadas para el ejercicio: no representan clientes reales ni relaciones comerciales. Los sitios están publicados y son funcionales.",
    ...
    en: {
      ...
      'cap.perf': "Asset optimization, lazy loading, Core Web Vitals. 90+ Lighthouse scores across my demos (lab data).",
      ...
      'meta.work.description': "Published projects focused on identity, speed, structure and conversion: case studies with problem, solution, stack and outcome.",
      ...
      'about.timeline.i1.desc': "Corporate site for a creative agency and an 11-page AI platform with an ROI calculator, intent-based chat and PWA. Built as demos to production standards.",
      'about.timeline.i1.stack': "HTML · CSS · JavaScript · PWA · Schema.org",
      'about.timeline.i2.date': "2025",
      ...
      'case.gallery.num': "[ Gallery ]",
      'case.gallery.title': "The site on screen",
      'case.gallery.desktop': "Desktop",
      'case.gallery.mobile': "Mobile",
      'case.gallery.cover': "Home",
      'case.gallery.inner': "Inner section",
      'case.cucu.gal_d1': "Desktop view of Cucú Studio: home",
      'case.cucu.gal_d2': "Desktop view of Cucú Studio: inner section",
      'case.cucu.gal_m1': "Mobile view of Cucú Studio",
      'case.luco.gal_d1': "Desktop view of Luco Gourmet: home",
      'case.luco.gal_d2': "Desktop view of Luco Gourmet: inner section",
      'case.luco.gal_m1': "Mobile view of Luco Gourmet",
      'case.sellink.gal_d1': "Desktop view of Sellink Group: home",
      'case.sellink.gal_d2': "Desktop view of Sellink Group: inner section",
      'case.sellink.gal_m1': "Mobile view of Sellink Group",
      'case.cognition.gal_d1': "Desktop view of Cognition: home",
      'case.cognition.gal_d2': "Desktop view of Cognition: inner section",
      'case.cognition.gal_m1': "Mobile view of Cognition",
      ...
      'legal.terms.s2.p1': "All four projects shown on this site (Cucú Studio, Luco Gourmet, Sellink Group, Cognition) are self-initiated demos built by Rony Cozzi around fictional brands created for the exercise: they do not represent real clients or business relationships. The sites are live and functional.",
